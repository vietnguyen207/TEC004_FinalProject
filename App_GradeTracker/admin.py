...
@admin_bp.route("/pdanalytics/gpa")
@login_required
@admin_required
def analytics_gpa():
    df = calculate_gpa()
    gpa_data = df.to_dict(orient="records")
    return render_template("admin_page/gpa.html", gpa_data=gpa_data)
# ------------------------------------

@admin_bp.route("/pdanalytics/ranking/<semester>")
@login_required
@admin_required
def analytics_ranking(semester):
    df = class_ranking(semester)
    
    # Convert DataFrame to a list of dictionaries
    ranking_data = df.to_dict(orient="records")
    
    return render_template(
        "admin_page/class_ranking.html", 
        semester=semester, 
...
def prediction_dashboard():
    ...
    return render_template(
        ...
        "admin_page/prediction_dashboard.html",
