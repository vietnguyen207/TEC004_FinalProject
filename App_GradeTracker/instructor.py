...
def attendance_report(course_id):
    ...
    report=attendance_report_page(course_id)
...
def assignments(course_id):
    ...
    return render_template(
        ...
        "instructor_page/assignments.html",
...
@instructor_bp.route(
"/course/<course_id>/assignment/create",
methods=["GET","POST"]
)
@login_required
@instructor_required
def create_assignment_page(course_id):
    ...
    if request.method=="POST":
        ...
        create_assignment(
            ...
            request.form["assignment_type"],

            request.form["description"],

            request.form["due_date"],

            float(request.form["max_points"])
    ...
    return render_template(
        ...
        "instructor_page/create_assignment.html",
...
def edit_assignment_page(assignment_id):
    ...
    return render_template(
        ...
        "instructor_page/edit_assignment.html",
...
def assignment_detail(assignment_id):
    ...
    return render_template(
        ...
        "instructor_page/assignment_detail.html",
...
@login_required
@instructor_required
def grade_submission_page(submission_id):
    ...
    return render_template(
        ...
        "instructor_page/grade_submission.html",
...
@instructor_bp.route(
    "/instructor_db/course/<course_id>/prediction"
)
@login_required
@instructor_required
def prediction_dashboard(course_id):
    ...
    stats = dashboard_statistics_service(
    ...
    return render_template(
        ...
        "instructor_page/prediction_dashboard.html",
...
@instructor_bp.route('/uploads/<path:filename>')
def download_file(filename):
    uploads_dir = os.path.join(instructor_bp.root_path, 'uploads')
