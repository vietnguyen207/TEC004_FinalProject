...
def build_all_features(conn):
    ...
    dataset["attendance_rate"] = dataset[
        "attendance_rate"
    ].fillna(0)

    dataset["completion_rate"] = dataset[
        "completion_rate"
    ].fillna(0)
...
def build_prediction_features(conn):
    ...
    prediction["assignment"] = prediction["assignment"].fillna(0)

    prediction["midterm"] = prediction["midterm"].fillna(0)

    prediction["attendance_rate"] = prediction["attendance_rate"].fillna(0)

    prediction["completion_rate"] = prediction["completion_rate"].fillna(0)
