...
def report_grade_distribution():
    ...
    return send_file(
        "reports/grade_distribution.png"
    )

# ------------------------------------

@app.route(
    "/report/gpa_trend/<student_id>"
)
def report_gpa_trend(
    ...
    return send_file(
        f"reports/gpa_trend_{student_id}.png"
    )

# ------------------------------------

@app.route(
    "/report/course_difficulty"
)
def report_course_difficulty():
    ...
    return send_file(
        "reports/course_difficulty.png"
    )

# ------------------------------------

@app.route(
    "/report/radar/<student_id>"
)
def report_radar(
    student_id
):
    ...
    return send_file(
        f"reports/radar_{student_id}.png"
    )
